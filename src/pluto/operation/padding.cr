module Pluto::Operation::Padding
  def padding(all : Int32 = 0, *, left : Int32 = 0, right : Int32 = 0, top : Int32 = 0, bottom : Int32 = 0, padding_type : PaddingType = PaddingType::Black) : self
  ...
  def padding!(all : Int32 = 0, *, left : Int32 = 0, right : Int32 = 0, top : Int32 = 0, bottom : Int32 = 0, padding_type : PaddingType = PaddingType::Black) : self
    ...
    each_channel do |channel, channel_type|
      new_channel = case padding_type
                    in PaddingType::Black then Array(UInt8).new((top + height + bottom) * new_width) { 0u8 }
                    in PaddingType::Repeat then Array(UInt8).new((top + height + bottom) * new_width) do |i|
